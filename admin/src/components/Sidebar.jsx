        ...
        <ul className="mt-2 flex flex-col gap-1">
          ...
          >
            <img
              ...
              alt=""
            />
            <p className="font-medium tracking-wide">Appointments</p>
          </NavLink>
          <NavLink
            className={({ isActive }) =>
              `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${
          ...
          >
            <img
              ...
              alt=""
            />
            <p className="font-medium tracking-wide">Add Doctors</p>
          </NavLink>
          <NavLink
            className={({ isActive }) =>
              `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${
          ...
          >
            <img
              ...
              alt=""
            />
            <p className="font-medium tracking-wide">Doctors List</p>
          </NavLink>
        </ul>
      )}
    </div>
